...
A worker resumes from checkpoint offset, parses appended lines, and emits raw plus normalized rows (and compacted expansions when present). Invalid or non-object lines are captured in `ingest_errors` and do not halt processing. [src: rust/ingestor/src/ingestor.rs:L597, rust/ingestor/src/ingestor.rs:L632, rust/ingestor/src/ingestor.rs:L635, rust/ingestor/src/normalize.rs:L372, rust/ingestor/src/normalize.rs:L724]

Batch chunks flow to a sink that flushes by size or timer in fixed order: `raw_events`, `normalized_events`, `compacted_expanded_events`, `ingest_errors`, `ingest_checkpoints`. Success advances counters/cache; failure retains buffers for retry. [src: rust/ingestor/src/ingestor.rs:L345, rust/ingestor/src/ingestor.rs:L471, rust/ingestor/src/ingestor.rs:L486, rust/ingestor/src/ingestor.rs:L512]
